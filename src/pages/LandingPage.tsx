  ...
  return (
    <div className="min-h-screen bg-[#0B0F12] text-white selection:bg-primary/30 selection:text-primary overflow-x-hidden pt-[80px]">
      ...
      <motion.a
        ...
        className="fixed bottom-24 right-8 z-[2000] w-[60px] h-[60px] bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(37,211,102,0.4)] transition-all group"
      >
