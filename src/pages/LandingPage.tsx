...
import { Zap, MessageSquare, BarChart3, TrendingUp, ShieldCheck, Rocket, ChevronRight, Globe, Instagram, Mail, Phone, MessageCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0B0F12] text-white selection:bg-primary/30 selection:text-primary overflow-x-hidden pt-[80px]">
      ...
      <section className="relative pt-[120px] pb-24 px-6 lg:px-12 max-w-7xl mx-auto z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] items-center gap-[80px]">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border-neon/20 mb-8 animate-pulse">
            ...
            <p className="text-[1.125rem] leading-[1.6] text-[#E5E7EB] font-medium max-w-2xl mb-12">
              CRM desenvolvido pela Top IA para empresas angolanas que querem crescer com automação e organização real.
            </p>
      ...
      <section id="features" className="py-32 px-6 lg:px-12 max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-24">
            <h2 className="text-4xl lg:text-5xl font-black uppercase italic tracking-tighter mb-6">Funcionalidades de <span className="text-primary">Elite</span></h2>
            <div className="h-1 w-24 bg-primary mx-auto rounded-full shadow-glow" />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { icon: MessageSquare, title: 'Chatbot Multi-Canal', desc: 'Centralize WhatsApp, Instagram e Landing Pages num só lugar.' },
            { icon: BarChart3, title: 'IA Preditiva', desc: 'Nossa inteligência analisa o comportamento do cliente para fechar mais vendas.' },
            { icon: TrendingUp, title: 'Gestão de Pipeline', desc: 'Pipeline visual e automatizado para não perder nenhuma oportunidade.' },
            { icon: ShieldCheck, title: 'Segurança Total', desc: 'Dados protegidos com criptografia de ponta a ponta e backups diários.' }
          ].map((item, i) => (
            <motion.div 
              key={i}
              ...
              className="glass-card p-10 rounded-[40px] hover:border-primary/50 transition-all group hover:-translate-y-2"
            >
      ...
      <section id="pricing" className="py-32 bg-white/5 relative z-10 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center mb-20">
                ...
                <p className="text-white/40 font-bold uppercase tracking-widest text-xs">Escolha o plano ideal para a escala do seu negócio</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <PricingCard 
                name="Starter"
                price="25.000 Kz"
                features={['1 Usuário', '500 Leads/mês', 'Chatbot Básico', 'Dashboard Mensal', 'Suporte Via Email']}
              ...
              <PricingCard 
                ...
                popular={true}
                highlight={true}
                features={['5 Usuários', '2.000 Leads/mês', 'Automações Avançadas', 'IA Treinada', 'Suporte Prioritário']}
                cta="Turbinar agora"
              />
              <PricingCard 
                name="Expert"
                price="100.000 Kz"
                isWhatsApp={true}
                features={['Usuários Ilimitados', 'Leads Ilimitados', 'Gestor de Conta Dedicado', 'IA Totalmente Customizada', 'Consultoria de Automação']}
      ...
      <footer className="pt-32 pb-12 px-6 lg:px-12 bg-[#0B0F12] relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24 border-t border-white/5 pt-24">
          <div className="space-y-8">
            ...
            <p className="text-white/40 text-sm leading-relaxed">
              Transformando a gestão comercial em Angola com inteligência artificial e automação de alta performance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/50 text-sm font-medium">
              <li className="flex items-center gap-3">
                ...
                <span>suporte@topconsultores.pt</span>
              </li>
              <li className="flex items-center gap-3">
          ...
          <div className="glass-card p-8 rounded-3xl border-primary/20">
            ...
            <p className="text-[10px] text-white/40 mb-6 uppercase leading-relaxed">Subscreva para receber insights de automação em primeira mão.</p>
            <div className="flex flex-col gap-2">
               <input type="email" placeholder="EMAIL" className="bg-white/5 border border-white/10 rounded-full px-6 py-3 text-[10px] focus:outline-none focus:border-primary/50" />
               <button className="bg-primary text-black font-black uppercase text-[10px] py-3 rounded-full shadow-glow">Aderir</button>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto border-t border-white/5 pt-12 text-center">
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/20">
              © 2026 TOP IA SOLUTIONS • DESENVOLVIDO POR ANTIGRAVITY • TODOS OS DIREITOS RESERVADOS
            </p>
        </div>
      </footer>
    </div>
