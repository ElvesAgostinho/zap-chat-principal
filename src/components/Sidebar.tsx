  ...
  const sidebarContent = (
    <div className="flex flex-col h-full bg-white border-r border-slate-200">
      ...
      <div className="flex items-center justify-center h-20 border-b border-slate-100 flex-shrink-0 mb-4 px-4">
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/30 relative overflow-hidden flex-shrink-0" title="ZapCRM PRO">
          <div className="absolute inset-0 bg-white/20 mix-blend-overlay"></div>
          <MessageSquare className="w-6 h-6 text-white fill-white/20 absolute" />
          <Zap className="w-3.5 h-3.5 text-white fill-white absolute" />
        </div>
      </div>
