...
export default function Sidebar({ active, onChange, alertCount = 0, orderCount = 0, chatCount = 0, showAdmin = false, onSearch, storeName }: SidebarProps) {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full bg-white border-r border-slate-200">
      {/* Logo */}
      <div className="flex items-center justify-center h-20 border-b border-slate-100 flex-shrink-0 mb-4 px-4">
        <div className="flex items-center gap-3 w-full justify-center">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/30 relative overflow-hidden flex-shrink-0">
          ...
          <div className="flex flex-col items-start">
            <span className="font-extrabold text-[18px] text-slate-800 leading-none tracking-tight">Zap<span className="text-blue-500">CRM</span></span>
            <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest leading-none mt-1">PRO VERSION</span>
          </div>
        </div>
      </div>
